    ...
    <div id="assets">
       <div id="assets-back-button" @click="$router.push('/digicure')" title="Back to DIGICURE main page"></div>
        <div id="components">
            <div class="grey-gradient" style="margin-top:-300px;">
                <div class="intro-space" style="padding-bottom:0px;">
                    ...
                    <div class="intro-subtitle" style=" margin-top:20px;">
                        Platform <br>components<br>and applications</div>
                    ...
                    <div class="intro-article" style="columns:1; max-width:900px">
                        ...
                        The platform integrates various data types – including high-resolution images, 3D models, and
        ...
        <div id="virtualreality">
            <div class="grey-gradient" style="margin-top:50px;">
                <div class="intro-space" style="padding-bottom:0px;">

                    <div class="intro-subtitle" style=" margin-top:20px;">
                        Educational <br>Virtual Reality</div>
